Shader "Unlit/assignment1"
{
    Properties
    {
        ...
        _Period1 ("Period", Range(0.0, 100.0)) = 1.0
        _Period2 ("Period", Range(0.0, 100.0)) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Optional: If you're using Unity's built-in shaders, this part ensures transparency
            ZWrite Off
            CGPROGRAM
            #pragma vertex vert
            ...
            {
                v2f o;
                v.vertex.x += sin(_Time.y + v.vertex.y * _Period1);
                v.vertex.y += sin(_Time.y + v.vertex.x * _Period2);
